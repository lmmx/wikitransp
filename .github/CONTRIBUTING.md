...
Firstly thank you for your interest in contributing to _wikitransp_!
...
Next get the latest checkout of the _wikitransp_ repository:

```sh
git clone git@github.com:lmmx/wikitransp.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of wikitransp along with its tests requirements:
...
Thank you for considering contribution to _wikitransp_!
